...
<body>
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <div class="verification-status <?= $is_verified ? 'verified' : 'unverified' ?>">
                <i class="fas <?= $is_verified ? 'fa-check-circle' : 'fa-exclamation-circle' ?>"></i>
                <span>
                    <?= $is_verified 
                        ? 'Your account is verified and active' 
                        : 'Your account is pending verification. Please upload ID proof below.' ?>
                </span>
            </div>
            ...
            <div id="profile" class="profile-section">
                ...
                <div class="id-proof-container">
                    ...
                    <?php if (!empty($profile['id_proof'])): ?>
                        <p>Your ID proof has been submitted and is under review.</p>
                        <img src="<?= htmlspecialchars($profile['id_proof']) ?>" alt="ID Proof" class="id-proof-image">
                        <?php if (!$is_verified): ?>
                            <div class="verification-note">
                                <p><i class="fas fa-info-circle"></i> Your verification is pending. You'll receive a notification once approved.</p>
                            </div>
                        <?php endif; ?>
                    <?php else: ?>
                        <p>Please upload a valid government-issued ID proof for verification (Aadhaar, PAN, Driver's License, etc.)</p>
                        ...
                        <div class="verification-note">
                            <p><strong>Note:</strong> Your account will be reviewed within 24-48 hours after submission. You'll receive a notification once verified.</p>
            ...
            <!-- Services Section (only shown if verified) -->
            <?php if ($is_verified): ?>
            ...
            <div class="verification-note" style="margin-bottom: 30px;">
                ...
                <p>You need to be verified before you can add and manage services. Please upload your ID proof above and wait for admin approval.</p>
            </div>
            <?php endif; ?>
        </div>
    </div>
